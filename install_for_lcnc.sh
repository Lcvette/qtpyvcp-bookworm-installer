...
# ensure pip and setuptools are uptodatre under ~/.local/lib/python3.9
...
# Install probe basic
zenity --question --text="Install Probe Basic user interface.\n\nINSTALL Yes or No?" --no-wrap --ok-label="yes" --cancel-label="no"
CHOICE=$?
