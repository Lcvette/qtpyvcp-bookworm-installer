...
sudo -A apt install -y python3-venv python3-pyqt5 python3-serial python3-dbus.mainloop.pyqt5 python3-pyqt5.qtopengl python3-pyqt5.qsci python3-pyqt5.qtmultimedia python3-pyqt5.qtquick qml-module-qtquick-controls gstreamer1.0-plugins-bad libqt5multimedia5-plugins pyqt5-dev-tools python3-dev python3-setuptools python3-wheel python3-pip python3-six python3-docopt python3-qtpy python3-pyudev python3-psutil python3-markupsafe python3-opengl python3-vtk9 python3-pyqtgraph python3-simpleeval python3-jinja2 python3-deepdiff python3-sqlalchemy python3-distro git qttools5-dev-tools qml-module-qtquick-controls2
SUDO_ERROR=$?
...
then
	...
	cp /home/$USERNAME/dev/probe_basic/dev_launchers/Probe\ Basic\ Rack\ ATC\ Mill\ Inch.desktop  ${XDG_DESKTOP_DIR:-$HOME/Desktop}/Probe\ Basic\ Rack\ ATC\ Mill\ Inch.desktop
	...
	sed -i "s/username/$USERNAME/g" ${XDG_DESKTOP_DIR:-$HOME/Desktop}/Probe\ Basic\ Rack\ ATC\ Mill\ Inch.desktop
